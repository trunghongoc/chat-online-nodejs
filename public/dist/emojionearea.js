 ...
 */
var base_URL = "https://chat-ahi.herokuapp.com/";
...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        //ban đầu: self.emojiTemplate = '<img alt="{alt}"  style="width:22px;height:22px;"  class="emojione' + (self.sprite ? '-{uni}" src="' + blankImg + '"/>' : 'emoji" src="{img}"/>');
        self.emojiTemplate = '<img alt="{alt}"  style="width:22px;height:22px;" class="emojione' + (self.sprite ? '-{uni}" src="' + blankImg + '"/>' : 'emoji" src="{img}"/>&nbsp;');
        ...
        if (options.autocomplete) {
            ...
            if ($.fn.textcomplete) {
                ...
                //link lúc đầu: https://cdn.rawgit.com/yuku-t/jquery-textcomplete/v1.3.4/dist/jquery.textcomplete.js
                $.getScript(base_URL+"dist/jquery.textcomplete.js",
                    autocomplete);
            }
        }
    ...
    var cdn = { 
        //link ban đầu: https://cdnjs.cloudflare.com/ajax/libs/emojione/
        defaultBase: base_URL,
        base: null,
        isLoading: false
    };
    function loadEmojione(options) {
        ...
        if (!cdn.isLoading) {
            if (!emojione || getSupportMode(detectVersion(emojione)) < 2) {
                cdn.isLoading = true;
                $.getScript(cdn.defaultBase + "dist/emojione.min.js", function () {
                    emojione = window.emojione;
                    emojioneVersion = detectVersion(emojione);
                    emojioneSupportMode = getSupportMode(emojioneVersion);
                    //ban đầu: cdn.base = cdn.defaultBase + emojioneVersion + "/assets";
                    cdn.base = cdn.defaultBase  + "icon";
                    if (options.sprite) {
                        var sprite = base_URL + "dist/emojione.sprites.css";
